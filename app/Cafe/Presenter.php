...
class Presenter
{
    ...
    function limitedTimeShort()
    {
        ...
        if ($this->cafe->limited_time === 'maybe') return '看情況';
    ...
    function limitedTime()
    {
        ...
        if ($this->cafe->limited_time === 'maybe') return self::getTailPart(Config::get('ui-text.limited_time.maybe'));
    ...
    function socketShort()
    {
        ...
        if ($this->cafe->socket === 'maybe') return '還好';
    ...
    function socket()
    {
        ...
        if ($this->cafe->socket === 'maybe') return self::getTailPart(Config::get('ui-text.socket.maybe'));
    ...
    {
        return view('partial/_business-hours-box', ['cafe' => $this->cafe]);
    }
